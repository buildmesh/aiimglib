...
- **Always read `docs/plans/2025-11-17-ai-gallery-v1.1-design.md`** at the start of a new conversation to understand the project's architecture, goals, style, and constraints.
- **Check ``docs/plans/2025-11-17-ai-gallery-v1.1-implementation.md`** before starting a new task. If the task isn't listed, add it with a brief description and today's date.
...
5. If you believe a full rewrite is necessary:
   - STOP
   - Explain why
   - Ask for approval before proceeding

### Prefrred Tools
- **Always use ripgrep for search** - don't use grep

### AI Behavior Rules
- **Never assume missing context. Ask questions if uncertain.**
- **Never hallucinate libraries or functions** — only use known, verified Kotlin packages.
